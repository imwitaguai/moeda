...
2. Adicione uma chave nova da OpenRouter como `OPENROUTER_API_KEY`.
3. Opcionalmente, configure `OPENROUTER_MODEL`, `SITE_URL` e `SITE_NAME` conforme o `.env.example`.
4. Configure um orçamento/limite de uso no painel da OpenRouter.
